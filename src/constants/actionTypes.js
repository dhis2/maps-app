...
export const LAYER_EDIT_DBSCAN_CLUSTERING_SET =
    'LAYER_EDIT_DBSCAN_CLUSTERING_SET'
export const LAYER_EDIT_DBSCAN_EPS_SET = 'LAYER_EDIT_DBSCAN_EPS_SET'
export const LAYER_EDIT_DBSCAN_MIN_POINTS_SET =
    'LAYER_EDIT_DBSCAN_MIN_POINTS_SET'
