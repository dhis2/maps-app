...
export const MAP_PERIODS_SYNC = 'MAP_PERIODS_SYNC'
...
export const LAYER_FORCE_CLIENT_CLUSTER_SET = 'LAYER_FORCE_CLIENT_CLUSTER_SET'
...
export const DATA_TABLE_ACTIVE_LAYER_SET = 'DATA_TABLE_ACTIVE_LAYER_SET'
export const DATA_TABLE_RESIZE = 'DATA_TABLE_RESIZE'
export const MAP_BOUNDS_CHANGED = 'MAP_BOUNDS_CHANGED'
export const TOGGLE_SHOW_ONLY_IN_VIEW = 'TOGGLE_SHOW_ONLY_IN_VIEW'
...
export const ACTIVE_TIMELINE_PERIOD_SET = 'ACTIVE_TIMELINE_PERIOD_SET'
export const DATA_TABLE_COMBINED_VIEW_TOGGLE = 'DATA_TABLE_COMBINED_VIEW_TOGGLE'
export const DATA_TABLE_JOIN_CONFIG_SET = 'DATA_TABLE_JOIN_CONFIG_SET'
export const DATA_TABLE_COMBINED_COLUMN_CONFIG_SET =
    'DATA_TABLE_COMBINED_COLUMN_CONFIG_SET'
export const COMBINED_VISIBLE_IDS_SET = 'COMBINED_VISIBLE_IDS_SET'

/* DATA FILTER */
export const DATA_FILTER_SET = 'DATA_FILTER_SET'
export const DATA_FILTER_CLEAR = 'DATA_FILTER_CLEAR'
export const DATA_FILTERS_CLEAR_ALL = 'DATA_FILTERS_CLEAR_ALL'
...
export const LAYER_EDIT_COUNT_EVENTS_OUTSIDE_OU_SET =
    'LAYER_EDIT_COUNT_EVENTS_OUTSIDE_OU_SET'
...
export const LAYER_EDIT_LABEL_DATA_ITEM_ID_SET =
    'LAYER_EDIT_LABEL_DATA_ITEM_ID_SET'
...
/* SELECTION */
export const FEATURE_TOGGLE_SELECTION = 'FEATURE_TOGGLE_SELECTION'
export const SELECTION_SET_ALL = 'SELECTION_SET_ALL'
export const SELECTION_ADD_RANGE = 'SELECTION_ADD_RANGE'
export const SELECTION_SET_CROSS_LAYER = 'SELECTION_SET_CROSS_LAYER'
