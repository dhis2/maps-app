...
describe('Layer#syncVisibleIds', () => {
    test('skips recomputing entirely when selection/selectionFilter/combinedVisibleIds are all referentially unchanged', () => {
        ...
        layer.syncVisibleIds(layer.props)

        expect(getVisibleIdsSpy).not.toHaveBeenCalled()
