...
const UserOrgUnitsThirdLevel = ({ style }) => (
    ...
    >
        ...
        <rect x="30.5" y="16.5" width="8" height="8" />
        <rect x="6.5" y="16.5" width="8" height="8" />
        <rect className="filled" x="12.5" y="32.5" width="8" height="8" />
        <rect className="filled" x="24.5" y="32.5" width="8" height="8" />
        <rect className="filled" x="36.5" y="32.5" width="8" height="8" />
        <rect className="filled" x="0.5" y="32.5" width="8" height="8" />
