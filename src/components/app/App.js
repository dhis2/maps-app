...
import { clearLoadError } from '../../actions/loadError.js'
...
const App = () => {
    ...
    const loadError = useSelector((state) => state.loadError)
        ...
        <>
            ...
            >
                ...
                <div className={styles.appMapAndTable}>
                    ...
                    {dataTableOpen && !loadError && <BottomPanel />}
                </div>
                {!downloadModeOpen && (
                    <DetailsPanel
