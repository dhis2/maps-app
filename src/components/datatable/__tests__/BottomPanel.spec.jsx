...
describe('BottomPanel layer selector', () => {
    ...
    test('falls back to the last-opened layer when the persisted activeLayerId is no longer open', () => {
        renderBottomPanel({
            dataTable: {
                ...DEFAULT_DATA_TABLE_STATE,
                openIds: ['layer1', 'layer2'],
                activeLayerId: 'layer3',
            },
            mapViews: twoEligibleLayers,
        })
    ...
    test('selecting an already-open layer while Combined is active switches back out of Combined view', () => {
        const { store } = renderBottomPanel({
            dataTable: {
                ...DEFAULT_DATA_TABLE_STATE,
                openIds: ['layer1', 'layer2'],
...
describe('BottomPanel clear filters (single-layer mode)', () => {
    test("clicking Clear filters in single-layer mode clears that layer's data filters", () => {
        const { store } = renderBottomPanel({
            dataTable: {
                ...DEFAULT_DATA_TABLE_STATE,
                openIds: ['layer1'],
