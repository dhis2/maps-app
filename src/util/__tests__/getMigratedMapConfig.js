...
// test.skip('extractBasemap when basemap is a string but not "none"', () => {
//     const config = {
//         id: 'mapId',
//         name: 'map name',
...
// test.skip('extractBasemap when basemap is string "none"', () => {
//     const config = {
//         id: 'mapId',
//         name: 'map name',
//         basemap: 'none',
...
// test.skip('extractBasemap when basemap is an object', () => {
//     const config = {
//         id: 'mapId',
//         name: 'map name',
//         basemap: {
...
// test.skip('extractBasemap when no basemap in config', () => {
//     const config = {
//         id: 'mapId',
//         name: 'map name',
//         mapViews: [
